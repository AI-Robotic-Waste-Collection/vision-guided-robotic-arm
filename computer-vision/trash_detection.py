...
# This uses your newly trained iPhone-camera model.
MODEL_PATH = Path(__file__).parent / "best.pt"

# Keep the old model safely inside the same folder:
# best.pt
# best_working_backup.pt
...
# Laptop camera is usually 0.
# iPhone virtual camera is usually 1 or 2.
CAMERA_INDEX = 1

CAMERA_WIDTH = 640
CAMERA_HEIGHT = 480

# Start with 0.25 for the new phone-camera model.
...
def main() -> None:
    # Check the new model exists.
    if not MODEL_PATH.exists():
        print("ERROR: Model file was not found:")
        print(MODEL_PATH)
        print()
        print(
            "Make sure best_iphone_test.pt is inside the ai folder."
        )
        return

    print("Loading the new iPhone YOLO model...")
    ...
    try:
        while True:
            ...
            # Force the phone camera image to 640 x 480.
            frame = cv2.resize(
                frame,
            ...
            # ==================================================
            # CREATE THE 3 x 3 REACHABLE GRID
            # ==================================================
            ...
            # Robot can detect another paper ball only after
            # the previous object disappears from the camera.
            if (
                not armed
